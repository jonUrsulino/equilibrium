...
class HomeArrivingPlayer extends Equatable {
  const HomeArrivingPlayer(this.player, this.hasArrived);
  ...
  HomeArrivingPlayer copyWith(Player? player, bool? hasArrived) {
    return HomeArrivingPlayer(player = player ?? this.player,
