...
import 'package:equilibrium/data/data_source/local/store_shirt_data_source.dart';
...
import 'package:equilibrium/data/repository/shirt_repository.dart';
...
abstract class DiDomain {
  static void initializeDomainDependencies() {
    ...
    GetIt.I.registerSingleton<ShirtDataSource>(StoreShirtDataSource());
    ...
    GetIt.I.registerSingleton<ShirtRepository>(ShirtRepositoryImpl(GetIt.I.get<ShirtDataSource>()));
