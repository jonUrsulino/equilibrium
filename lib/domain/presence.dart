...
class PresencePlayers {
  ...
  final List<HomeArrivingPlayer> _listHomeArriving = [
    HomeArrivingPlayer.initial(Player.goalkeeper("Murilo", 5)),
    HomeArrivingPlayer.initial(Player.normal("Tiago Valadão", 5)),
    HomeArrivingPlayer.initial(Player.normal("Jocivaldo", 5)),
    HomeArrivingPlayer.initial(Player.normal("Jonathan", 4.5)),
    HomeArrivingPlayer.initial(Player.normal("Kennedy", 4.5)),
    HomeArrivingPlayer.initial(Player.normal("Eli", 4.5)),
    HomeArrivingPlayer.initial(Player.normal("Samuel", 4.5)),
    HomeArrivingPlayer.initial(Player.normal("Pr. Wilson", 4.5)),
    HomeArrivingPlayer.initial(Player.normal("Henrique", 4)),
    HomeArrivingPlayer.initial(Player.normal("Carlos", 4)),
    HomeArrivingPlayer.initial(Player.normal("Danilo", 4)),
    HomeArrivingPlayer.initial(Player.normal("Rubens", 3.5)),
    HomeArrivingPlayer.initial(Player.normal("Tchuco", 3.5)),
    HomeArrivingPlayer.initial(Player.normal("Phelip", 3.5)),
    HomeArrivingPlayer.initial(Player.normal("Ismael", 3)),
    HomeArrivingPlayer.initial(Player.normal("Edmilson", 3)),
    HomeArrivingPlayer.initial(Player.normal("Davi Bispo", 3)),
    HomeArrivingPlayer.initial(Player.normal("Adriano Bispo", 3)),
    HomeArrivingPlayer.initial(Player.goalkeeper("Fabio Benatti", 3)),
    HomeArrivingPlayer.initial(Player.normal("Mike", 2)),
    HomeArrivingPlayer.initial(Player.normal("Igão", 2)),
