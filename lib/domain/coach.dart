...
class Coach {
  ...
  Future<List<PresencePlayer>> getArrivedPlayersFiltered(bool balanceGoalkeeper) async {
    ...
    for (var item in lists) {
      print("getArrivedPlayersFiltered item: $item");
    }
